# nvim-treesitter-queries-groq

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-groq/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-groq/actions/workflows/validate.yml)

Neovim tree-sitter queries for **groq**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-groq",
...
- [ ] Changes are scoped to `groq` — do not include files for other languages
